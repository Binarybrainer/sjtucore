...
void check_operation(std::unique_ptr<Vnbit_mux_cell>& mux, VerilatedVcdC* tfp, vluint64_t& sim_time) {
...
int main(int argc, char** argv) {
    ...
    std::unique_ptr<Vnbit_mux_cell> mux = std::make_unique<Vnbit_mux_cell>();
